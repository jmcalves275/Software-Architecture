...
public class NewJFrame extends javax.swing.JFrame {
    ...
    ShippingInterfaceService sis = new ShippingInterfaceService();
    ShippingInterface shipping = sis.getShippingInterfacePort();
    ...
    private void initComponents() {
        ...
        jTextField1.setText("andrepcg.myftp.org");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if ( !connectError && !orderBlank )
        {
            try
            {
                ...
                SQLStatement = "SELECT * FROM productsinorders where order_id = " + Integer.parseInt(orderID);
                res = s.executeQuery( SQLStatement );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ( !connectError )
        {
            try
            {
                ...
                Shipping sh = shipping.writeOnFile(updateOrderID);

                if(sh.isSuccess())
                	jTextArea1.setText("\nLog update sent");
                else
                	jTextArea1.setText("\nLog update failed to send");
