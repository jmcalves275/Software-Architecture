...
public class FilterFramework extends Thread
{
	...
	****************************************************************************/
	...
	void ClosePorts()
	{
		...
		{
			InputReadPort.close();
			// TODO source fecha a stream antes dos seguintes acabarem de a ler
	...
	****************************************************************************/
	...
	void writeFrameToOutput(byte[] frame){
